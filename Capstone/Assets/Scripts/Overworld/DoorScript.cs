...
namespace Yarn.Unity.Example
{
    public class DoorScript : MonoBehaviour
    {
        ...
        Vector3 playerPos; //The player's position when opening the door
        ...
        bool doorEnabled = false; //Whether the door can be interacted with.
        ...
        void Update()
        {
            ...
            if (doorEnabled && active && playerOver) //If the door is active and the player is over it, open the door
            {
                openDoor();
            }
